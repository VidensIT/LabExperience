...
read -n 1 -p "Wait for respource creation, press any key…" any
...
#az vm create --name "testisatestvm" --size Standard_A1 --resource-group tj_VELO_vVCE_RG --vnet-name tj_VELO_vVCE_AZURE --subnet 'tj_VELO_vVCE_SN_Public_JH' --image UbuntuLTS --generate-ssh-keys
